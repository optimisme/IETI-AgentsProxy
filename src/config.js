...
module.exports = {
  ...
  maxTokensPerRequest: numberEnv('MAX_TOKENS_PER_REQUEST', 16384),
  defaultDailyTokenLimit: numberEnv('DEFAULT_DAILY_TOKEN_LIMIT', 10000000),
  defaultModelContextLimit: numberEnv('DEFAULT_MODEL_CONTEXT_LIMIT', 131072),
  defaultModelOutputLimit: numberEnv('DEFAULT_MODEL_OUTPUT_LIMIT', 16384),
